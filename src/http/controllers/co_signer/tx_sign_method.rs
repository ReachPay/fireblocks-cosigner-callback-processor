...
#[my_http_server_swagger::http_route(
    method: "POST",
    route: "/v2/tx_sign_request",
    description: "Transaction Signing Callback Handler",
    controller: "CoSigner",
...
pub struct FireblocksSignTxAction {
    app: Arc<AppContext>,
}

impl FireblocksSignTxAction {
